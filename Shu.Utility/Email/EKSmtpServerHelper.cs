...
namespace Shu.Utility
{
    ...
    /// 添加附件
    /// </summary>
    public class EKMailAttachments
    {
        #region 构造函数
        public EKMailAttachments()
        {
    ...
    /// 邮件信息
    /// </summary>
    public class EKMailMessage
    {
        #region 构造函数
        public EKMailMessage()
        {
            _Recipients = new ArrayList();        //收件人列表
            _Attachments = new EKMailAttachments(); //附件
        ...
        private EKMailAttachments _Attachments;//附件
        ...
        /// 附件
        /// </summary>
        public EKMailAttachments Attachments
        {
    ...
    /// 邮件操作
    /// </summary>
    public class EKSmtpServerHelper
    {
        #region 构造函数、析构函数
        public EKSmtpServerHelper()
        {
            SMTPCodeAdd();
        }
        ...
        private bool SendEmail(string smtpServer, int port, bool ESmtp, string username, string password, EKMailMessage mailMessage)
        {
        ...
        /// <param name="port">端口，默认为25</param>
        /// <param name="mailMessage">邮件内容</param>
        public bool SendEmail(string smtpServer, int port, EKMailMessage mailMessage)
        {
        ...
        /// <param name="password">发信人邮箱密码</param>
        /// <param name="mailMessage">邮件内容</param>
        public bool SendEmail(string smtpServer, int port, string username, string password, EKMailMessage mailMessage)
        {
    ...
    //mail.Attachments=ma;
    //mail.Body="你好";
    //mail.AddRecipients("diystring@qq.com");
    //mail.From="diystring@qq.com";
    //mail.FromName="String";
    //mail.Subject="Hello";
    //SmtpClient sp = new SmtpClient();
    //sp.SmtpServer = "smtp.qq.com";
    //sp.Send(mail, "diystring@qq.com", "123456");
    //------------------------------------------------
    public class EKSmtpClient
    {
        #region 构造函数
        public EKSmtpClient()
        { }

        public EKSmtpClient(string _smtpServer)
        {
        ...
        public bool Send(EKMailMessage mailMessage, string username, string password)
        {
            EKSmtpServerHelper helper = new EKSmtpServerHelper();
