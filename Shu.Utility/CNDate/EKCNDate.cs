...
namespace Shu.Utility
{
    ...
    public class EKChinaDate
    {
        ...
        /// 获取农历
        /// </summary>
        public static EKCNDate getChinaDate(DateTime dt)
        {
            EKCNDate cd = new EKCNDate();
            int year = dt.Year;
            int month = dt.Month;
            int date = dt.Day;
    ...
    //-------------------------------------------------------------------------------
    public class EKChineseCalendar
    {
        #region 内部结构
        /// <summary>
        /// 阳历
        ...
        /// 用一个标准的公历日期来初使化
        /// </summary>
        public EKChineseCalendar(DateTime dt)
        {
            int i;
            int leap;
            int temp;
            ...
            //计算两天的基本差距
            TimeSpan ts = _date - EKChineseCalendar.MinDay;
            offset = ts.Days;
        ...
        public EKChineseCalendar(int cy, int cm, int cd, bool leapMonthFlag)
        {
