...
{
    public class EKVideoConvert : System.Web.UI.Page
    {
        public EKVideoConvert()
        { }
        ...
        {
            string ffmpeg = Server.MapPath(EKVideoConvert.ffmpegtool);
            if ((!System.IO.File.Exists(ffmpeg)) || (!System.IO.File.Exists(fileName)))
            {
                return "";
            }
            string flv_file = System.IO.Path.ChangeExtension(playFile, ".flv");
            string FlvImgSize = EKVideoConvert.sizeOfImg;
        ...
        {
            string tool = Server.MapPath(EKVideoConvert.mencodertool);
