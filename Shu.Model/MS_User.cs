...
namespace Shu.Model
{
    ...
    public partial class MS_User
    {
        ...
        public Nullable<decimal> F_Integral { get; set; }
        public Nullable<int> F_IsSubscribe { get; set; }
        public string F_SubscribeEmail { get; set; }
